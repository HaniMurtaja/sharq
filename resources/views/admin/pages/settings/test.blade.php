...
<div class="mobileNavbar bg-sidebar">
    ...
    <div class="logoWrapper">
        <img src="/new/src/assets/images/logo.png" alt="" width="100" height="100" />
    </div>
...
<div class="d-flex flex-column flex-shrink-0 customSidebar rounded-4 bg-sidebar " id="sidebar"
    style="width: 4.5rem; height: 94vh;position: fixed;top: 6px; z-index:1;">
    ...
    <a href="#" class="d-block link-dark text-decoration-none logoImage" data-bs-toggle="tooltip"
        ...
        title="ALSHROUQ">
        <img src="/new/src/assets/images/logo ALSHROUQ DELIVERY white.png" alt="ALSHROUQ" width="100" height="100"
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link" aria-current="page" data-bs-toggle="tooltip"
                    ...
                    <span class="menuMobileItem">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{ route('index') }}" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                    ...
                    <span class="menuMobileItem">Dispatcher</span>
                </a>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu text-small shadow">
                    ...
                    <li><a class="dropdown-item" href="{{ route('operators.operator-reports') }}">Operators Report</a>
                    </li>
                </ul>
            </li>

            <li>
                <a href="{{ route('clients') }}" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Clients">
                    <svg width="25.6px" height="25.6px" viewBox="0 0 32 32" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span class="menuMobileItem">Clients</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('users') }}" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                    ...
                    <span class="menuMobileItem">Users</span>
                </a>
            </li>
            <li>
                <a href="{{ route('vehicles') }}" class="nav-link" data-bs-toggle="tooltip"
                    data-bs-placement="right" title="Vehicles">
                    <svg width="25.6px" height="25.6px" viewBox="0 0 39 37" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span class="menuMobileItem">Vehicles</span>
                </a>
            </li>
            <li>
                <a href="{{ route('orders') }}" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Orders">
                    <svg width="25.6px" height="25.6px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <span class="menuMobileItem">Orders</span>
                </a>
            </li>
            <li class="dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
                    ...
                    <span class="menuMobileItem">Reports</span>
                </a>
                <ul class="dropdown-menu text-small shadow reportsSideMenu">
                    <li><a class="dropdown-item" href="{{ route('reports') }}">Orders Reports</a></li>
                    <li><a class="dropdown-item" href="{{ route('reports.billings') }}">Drivers Reports</a></li>
                    <li><a class="dropdown-item" href="{{ route('operators.operator-reports') }}">Brands Reports</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="{{ route('orders') }}" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Intergrations">
                    <svg version="1.1" height="25.6px" width="25.6px" id="Layer_1"
            ...
            <li>
                <a href="{{ route('orders') }}" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Locations">
                    <svg fill="#fff" height="25.6px" width="25.6px" version="1.1" id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    @endif
    @if (auth()->user()->user_role?->value == 2 || auth()->user()->user_role?->value == 4)
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link" aria-current="page" data-bs-toggle="tooltip"
                    data-bs-placement="right" title="Dashboard">
...
<div class="d-flex flex-column flex-shrink-0 customSidebar rounded-4 bg-sidebar " id="sidebar"
    ...
    <a href="#" class="d-block link-dark text-decoration-none" data-bs-toggle="tooltip"
        data-bs-placement="right" style="width: 48.95px; height: 48.95px; border-radius: 50%; margin-bottom: 16px;"
        title="ALSHROUQ">
        <img src="/new/src/assets/images/logo-sm.png" alt="ALSHROUQ" width="100" height="100"
            style="width: 100%; height: 100%; border-radius: 50%;" />
    ...
    @if (auth()->user()->user_role?->value == 1)
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
                <a href="{{ route('clients') }}" class="nav-link" data-bs-toggle="tooltip"
                    data-bs-placement="right" title="Clients">
                    <svg width="25.6px" height="25.6px" viewBox="0 0 32 32" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M4.01343 14.96V20.9466C4.01343 26.9333 6.41343 29.3333 12.4001 29.3333H19.5868C25.5734 29.3333 27.9734 26.9333 27.9734 20.9466V14.96"
    ...
    <div class="dropdown">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
            data-bs-toggle="tooltip" data-bs-placement="right" title="Operators">
            <span class="tooltip-element" data-bs-toggle="tooltip" data-bs-placement="right" title="Profile"></span>
