...
<div id="repeater-per-stop">
    @if (isset($calculation_method) && !empty($calculation_method->data['km1']))
        @foreach ($calculation_method->data['km1'] as $index => $value)
            <div class="row mb-2 align-items-center">
                <!-- Km 1 -->
                <div class="col-md-2">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="km1[]" value="{{ $value }}" >
                ...
                <div class="col-md-2">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="km2[]" value="{{ $calculation_method->data['km2'][$index] ?? '' }}" >
                ...
                <div class="col-md-2">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="fees_for_km[]" value="{{ $calculation_method->data['fees_for_km'][$index] ?? '' }}" >
                ...
                <div class="col-md-2">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="fees_per_stop[]" value="{{ $calculation_method->data['fees_per_stop'][$index] ?? '' }}" >
                ...
                <div class="col-md-2">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="pickup_fees[]" value="{{ $calculation_method->data['pickup_fees'][$index] ?? '' }}" >
                ...
                <div class="col-md-2">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="dropoff_fees[]" value="{{ $calculation_method->data['dropoff_fees'][$index] ?? '' }}" >
