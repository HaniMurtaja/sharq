...
@if (isset($calculation_method))
    <div id="city-to-city-repeater">
        @for ($i = 0; $i < count($calculation_method->data['from_city']); $i++)
            <div class="row mb-2 align-items-center city-to-city-row">
                <!-- From City -->
                <div class="col-md-3">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="from_city[]">
                            ...
                            @foreach ($all_cities as $city)
                                <option value="{{ $city->id }}"
                                    {{ $city->id == $calculation_method->data['from_city'][$i] ? 'selected' : '' }}>
                                    {{ $city->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-3">
                    <div class="form-group mb-0">
                        <select class="form-control select2" style="width: 100%;" name="to_city[]">
                            ...
                            @foreach ($all_cities as $city)
                                <option value="{{ $city->id }}"
                                    {{ $city->id == $calculation_method->data['to_city'][$i] ? 'selected' : '' }}>
                                    {{ $city->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-3">
                    <fieldset class="floating-label-input">
                        <input type="text" class="" name="colle_amount[]"
                            value="{{ $calculation_method->data['colle_amount'][$i] }}">
