...
@if (isset($calculation_method))
    <div id="area-to-area-repeater">
        @for ($i = 0; $i < count($calculation_method->data['from_city']); $i++)
            <div class="row mb-2 align-items-center">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="from_city[]">
                            ...
                            @foreach ($all_cities as $city)
                                <option value="{{ $city->id }}"
                                    {{ isset($calculation_method->data['from_city'][$i]) && $calculation_method->data['from_city'][$i] == $city->id ? 'selected' : '' }}>
                                    {{ $city->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select class="form-control select2" style="width: 100%;" name="from_area[]">
                            ...
                            @foreach ($all_areas as $area)
                                <option value="{{ $area->id }}"
                                    {{ isset($calculation_method->data['from_area'][$i]) && $calculation_method->data['from_area'][$i] == $area->id ? 'selected' : '' }}>
                                    {{ $area->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-2">
                    <div class="form-group mb-0">
                        <select class="form-control select2" style="width: 100%;" name="to_city[]">
                            ...
                            @foreach ($all_cities as $city)
                                <option value="{{ $city->id }}"
                                    {{ isset($calculation_method->data['to_city'][$i]) && $calculation_method->data['to_city'][$i] == $city->id ? 'selected' : '' }}>
                                    {{ $city->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-2">
                    <div class="form-group mb-0">
                        <select class="form-control select2" style="width: 100%;" name="to_area[]">
                            ...
                            @foreach ($all_areas as $area)
                                <option value="{{ $area->id }}"
                                    {{ isset($calculation_method->data['to_area'][$i]) && $calculation_method->data['to_area'][$i] == $area->id ? 'selected' : '' }}>
                                    {{ $area->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-2">
                    <fieldset class="form-group mb-0 floating-label-input">
                        <input type="text" class="" name="amount[]"
                            value="{{ $calculation_method->data['amount'][$i] ?? '' }}">
