<style>
    ...
    .clientOrders.branches .dt-layout-row,
    .clientOrders.users .dt-layout-row {
        padding: 0 20px;
    }
...
<section class="globalForm">
    <div class="globalHeader">
        ...
        <div class="d-flex flex-column">
            <h1 id="client_name"> 2Gout Burger - Kitchen Park Jarir - 22698</h1>
            <div class="text-slide-wrapper">
                <p class="text-slide clientToken">Token: <span id="integration_token"></span></p>
            </div>
        ...
        <button class=" NewButton new-option edit-client" data-type="client">Edit</button>
    </div>

    <div class="sectionGlobalForm clientOrders p-19px flex-row align-items-center justify-content-between">
        <p class="sectionTitle">Client Status</p>
        <div class=" p-0 form-switch d-flex justify-content-between align-items-center">
            <input class="form-check-input position-relative client-active-toggle"   type="checkbox" role="switch" id="client_active_input"
                name="c">
        </div>
    </div>

    <!--Client Information-->
    <div class="sectionGlobalForm">
        <p class="sectionTitle">Inforamtion</p>
        <div class="informationDetailsCards">
            ...
            <div class="informationDetailsCard">
                ...
                <div class="text-slide-wrapper">
                    <p id="client_name2" class="text-slide clientName">"BK" 2Gout Burger - Kitchen Park Jarir </p>
                </div>
                <p id="client_id">22698</p>
            ...
            <div class="informationDetailsCard">
                ...
                <p class="text-black"><span id="total_orders_count">1</span> Order</p>
                <p>Total order</p>
            ...
            <div class="informationDetailsCard" data-bs-toggle="modal" data-bs-target="#rechargeModal">
                ...
                <p class="totalBalance text-black"><span id="total_balance_client">0</span> SAR</p>
                <p>Total balance</p>
        ...
        <div class="informationFields">
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="account_number" placeholder="Account Number" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_country" placeholder="client country" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_city" placeholder="City" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_currency" placeholder="Name" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_parial_pay" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_defualt_preperation_time" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_min_preperation_time" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_client_group" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="client_operator_group" disabled>
            ...
            <div class="custom-fieldset">
                ...
                <input type="text" class="input-field" id="price_order_group" disabled>
        ...
        <div class="collapse-container">
            <a class="collapse-tab collapsed" id="systemBillingTemplate" data-bs-toggle="collapse"
                href="#actionsInformation" role="button" aria-expanded="false" aria-controls="collapseExample">
            ...
            <div class="collapse" id="actionsInformation">
                <div class="card card-body">
                    ...
                    <div class="form-check p-0 form-switch d-flex justify-content-between align-items-center">
                        <label class="form-check-label" for="d">Wallet</label>
                        <input class="form-check-input position-relative" type="checkbox" role="switch"
                            id="d" name="d">
                    </div>
        ...
        <!-- Ordering Options Collapse -->
        <div class="collapse-container">
            <a class="collapse-tab collapsed" id="systemBillingTemplate" data-bs-toggle="collapse"
                href="#orderingOptionsInformation" role="button" aria-expanded="false"
            ...
            <div class="collapse" id="orderingOptionsInformation">
                <div class="card card-body">

                    <div class="form-check p-0 form-switch d-flex justify-content-between align-items-center">
                        <label class="form-check-label" for="f">Hide customer Name</label>
                        <input class="form-check-input position-relative" type="checkbox" role="switch"
                            id="f" name="f">
                    </div>

                    <div class="form-check p-0 form-switch d-flex justify-content-between align-items-center">
                        <label class="form-check-label" for="e">Hide customer Phone</label>
                        <input class="form-check-input position-relative" type="checkbox" role="switch"
                            id="e" name="e">
                    </div>
    ...
    <div class="sectionGlobalForm clientOrders">
        ...
        <div class="scrollable-table-custom">
            <table id="orders-table" style="padding-left: 30px" class="table">
                <thead>
    ...
    <!--Client Branches -->
    <div class="sectionGlobalForm clientOrders branches">
        <div class="d-flex justify-content-between align-items-center">
            <p class="sectionTitle d-flex align-items-center">
                ...
                <button id="upload-client-branch" class="addBtn d-flex uploadBranchesBtn align-items-center"
                    data-bs-toggle="modal" data-bs-target="#uploadBranchModal"> <svg
                        xmlns="http://www.w3.org/2000/svg" fill="#f46624" width="12.8px" height="12.8px"
                        viewBox="0 0 24 24">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    ...
    <!--Client Users -->
    <div class="sectionGlobalForm clientOrders users">
        <div class="d-flex justify-content-between align-items-center">
