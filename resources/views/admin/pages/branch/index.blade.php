        ...
        <div class="">
            ...
            <div class="flex flex-col items-center justify-center mb-192 pb-192 border-b md:flex-row md:justify-between">
                <div class="flex flex-col">
                    <h3 class="text-black fs-192 fw-bold m-0 ">Branch</h3>
                </div>

                {{-- <a href="{{ route('branchnew.create') }}" class="bg-red-a3 px-4 py-2 text-white br-96 fw-bold  fs-112">+
                    New
                    Branch</a> --}}
                            ...
                            @forelse ($items as $item)
                                <tr class="fs-112 text-center black-58">
                                    ...
                                    <td class="pxy-1288 d-flex gap-2">
                                        ...
                                        <a href="{{ route('branchnew.edit', ['id' => $item->id]) }}"
                                        ...
                                        {{-- <form method="POST"
                                            action="{{ route('branchnew.destroy', ['id' => $item->id]) }}"
