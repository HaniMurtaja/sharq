...
<div id="drawer-overlay" data-drawer="Countries" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50 drawer-overlay">
</div>


<div id="drawer_countries" data-drawer="Countries"
    ...
    <div class="flex flex-col h-screen overflow-scroll">
        <div class="flex items-center justify-between mb-6">
            <h5 class="text-xl font-bold text-blue-gray-700" id="country_title">New Country</h5>
        ...
        <div class="flex flex-col gap-2 p-8">
            <form style="margin-top: 0px" id="country-form">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <div>
                            <label for="branch-group-name">Country Name</label>
                            <input type="text" class="w-full border rounded-md border-gray5 h-[2.9rem] px-3"
                                id="country_name" name="country_name">

                            <input name="country_id" id="country_id" hidden>
                            <span style="color:red" id="country_name_error"></span>
                        </div>
                    </div>
