...
@section('content')
    <section class="dashboardContainer">
        <div class="flex flex-col items-center justify-center mb-192 border-b md:flex-row md:justify-between">
            <div class="flex flex-col mb-192">
                <h3 class="text-black fs-192 fw-bold m-0 ">Dashboard</h3>
            </div>
        ...
        <div class="">
            ...
            <div class=" pxy-256 bg-white br-96 mb-192">
                <p class="fs-128 gap-2 gray-94 fw-semibold mb-3 pb-3 d-flex align-items-center border-bottom">
                    <img src="{{ asset('new/src/assets/icons/filter.svg') }}" class="brightness-50" width="16" alt="" />
                    Filters
                </p>

                <div class="row gy-3 mt-3">
                    <div class="col-md-3">
                        <label for="template-name" class="custom-legend bg-white">
                            City <span class="text-danger d-none">*</span>
                        </label>
                        <select class=" seelct22" name="city_id" id="city_id">
                    ...
                    <div class="col-md-3">
                        <span class="custom-legend bg-white">Data From</span>
                        <div class="form-floating">
                            <input type='text' id="from_date" class="form-control datetimepicker1" />
                        </div>
                    </div>
                    <div class="col-md-3 ">
                        <span class="custom-legend bg-white">Data To</span>
                        <div class="form-floating">
                            <input type='text' id="to_date"class="form-control datetimepicker1" />
                        </div>
                    </div>

                    <div class="col-12 text-end">
                        <button id="filter" class="pxy-828 text-white br-96 bg-red-a3 fs-112 fw-semibold">Filter</button>
                    </div>
                </div>
            </div>
        ...
        <div class="chartsContainer">
            ...
            <div class="ChartContainer">
                <div class="chartHeader">
                    ...
                    <div class="text-right">
                        <p class="chartCounter" id="total_orders_count">0</p>
                        <button id="reportBtn" class="moreDetailsBtn">Show Orders Report</button>
                        <!-- Bootstrap Modal -->


                        @include('admin.pages.dashboard.model.clientorders')



                        <!-- jQuery script to call the report API and show modal -->

                        {{-- <a href="{{route('OrderDashboard')}}" target="_blank" class="moreDetailsBtn">See more details</a> --}}
                    </div>

                </div>
                <div id="bar-chart" style="width:100%; height:300!important;"></div>
            ...
            <div class="ChartContainer" style="">
                <div class="chartHeader">
                    ...
                    <div class="text-right">
                        <p class="chartCounter" id="countordercity">0</p>

                            <button id="cityreportBtn" class="moreDetailsBtn">Show Orders Report</button>
                            @include('admin.pages.dashboard.model.per-city-orders')
                    </div>
            ...
            <div class="ChartContainer" style="">
                <div class="chartHeader">
                    <div class="d-flex align-items-center chartTitle">
                        ...
                        <h2>Orders per Client</h2>
                    </div>
                    <div class="text-right">
                        <p class="chartCounter" id="countorderclient">0</p>
                            <button id="clientreportBtn" class="moreDetailsBtn">Show Orders Report</button>
                            @include('admin.pages.dashboard.model.per-client-orders')
                    </div>

                </div>
                <ul class="pagination justify-content-end mt-3" id="chartPagination"></ul>
                <div id="orders-per-client-chart" style="width:100%; height:300px;"></div>
    ...
    <div class="modal fade dashboardModal" id="OrdersDetailsDashBoard" data-bs-backdrop="static"
        data-bs-keyboard="false" tabindex="-1" aria-labelledby="rechargeModalLabel" aria-hidden="true">
    ...
    <div class="modal fade dashboardModal" id="OperatorsDetailsDashBoard" data-bs-backdrop="static"
        data-bs-keyboard="false" tabindex="-1" aria-labelledby="rechargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="operatorsDetailsFilters">
                        ...
                        <div class=" searchBox flex items-center justify-between gap-3 p-2 bg-white  rounded-md">
                            <!-- Input -->
                            <input type="text" placeholder="Search with driver name or phone..."
                                class=" bg-transparent outline-none border-0"
                                style="font-size: 11.2px; color: #585858;width: 100%" id="search">
                            <!-- Icon -->
        ...
        @include('admin.pages.dashboard.script.dashboardScripts')
        @include('admin.pages.dashboard.script.script')
        @include('admin.pages.dashboard.script.scriptpercity')
        @include('admin.pages.dashboard.script.scriptperclient')
    @endsection
