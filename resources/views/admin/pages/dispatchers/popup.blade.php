<div class="modal-content mainPopup a18rngvp jocrykp">
            ...
            <div class="driverImageData">
                <div class="driverImageWrapper">
                    ...
                    @if ($order->driver_name)
                        <img src="{{ $order->driver_photo ? $order->driver_photo : 'https://cdn-icons-png.flaticon.com/512/149/149071.png' }}"
                            alt="Driver Image" width="100" height="100">
                    @else
                        <!-- Add SVG vector for "Add Person" -->
                        <svg style="width: 100%; height: 100%; fill: #f46624;" xmlns="http://www.w3.org/2000/svg"
                            width="100" height="100" fill="currentColor" class="bi bi-person-plus"
                            viewBox="0 0 16 16">
                            <path
                                d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 1a5 5 0 0 0-4.546 2.914C3.486 13.1 4.418 14 6 14h4c1.582 0 2.514-.9 2.546-2.086A5 5 0 0 0 8 9zm5-2a.5.5 0 0 1 .5.5V8h1.5a.5.5 0 0 1 0 1H13.5v1.5a.5.5 0 0 1-1 0V9H11a.5.5 0 0 1 0-1h1.5V6.5a.5.5 0 0 1 .5-.5z" />
                        </svg>
                    @endif
                </div>
                <div class="driverData">
                    @if ($order->driver_name)
                        <p class="driverName" style="color: #f46624;">
                            {{ $order->driver_name }}
                        </p>
                    @else
                        @can ('can_assign_orders')
                            <a href="#" class="assignDriverBtn" id="assignDriverBtn" data-id="{{ $order->id }}"
            ...
            <div class="icon">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        @can ('can_assign_orders')
                            <li><a class="dropdown-item open-modal-test" href="#" data-id="{{ $order->id }}"
    ...
    <div class="stepper-wrapper">
        <div class="stepper-item  {{ $order->assign_date ? 'completed' : '' }}">
        ...
        <div class="stepper-item {{ $order->accept_date ? 'completed' : '' }} ">
            <div class="step-counter">
                <svg fill="#4bb543" width="64px" height="64px" viewBox="0 0 200.00 200.00" data-name="Layer 1"
                    id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.002">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            ...
            <div class="step-name">
                ...
                <p>
                    <span>{{ $order->assign_date }}</span>

                </p>
            </div>
        </div>
        <div class="stepper-item {{ $order->arrive_branch_date ? 'completed' : '' }} ">
            <div class="step-counter">
                <svg fill="#4bb543" width="64px" height="64px" viewBox="0 0 200.00 200.00" data-name="Layer 1"
                    id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.002">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            ...
            <div class="step-name">
                ...
                <p>
                    <span>{{ $order->accept_date }}</span>
                </p>
            </div>
        </div>
        <div class="stepper-item {{ $order->recive_date ? 'completed' : '' }}">
            <div class="step-counter">
                <svg fill="#4bb543" width="64px" height="64px" viewBox="0 0 200.00 200.00" data-name="Layer 1"
                    id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.002">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            ...
            <div class="step-name">
                ...
                <p>
                    <span>{{ $order->arrive_branch_date }}</span>
            </div>
        </div>

        <div class="stepper-item {{ $order->arrive_client_date ? 'completed' : '' }}">
            <div class="step-counter">
                <svg fill="#4bb543" width="64px" height="64px" viewBox="0 0 200.00 200.00" data-name="Layer 1"
                    id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.002">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            ...
            <div class="step-name">
                ...
                <p>
                    <span>{{ $order->recive_date }}</span>
                </p>
            </div>
        </div>

        <div class="stepper-item {{ $order->delivery_date ? 'completed' : '' }}">
            <div class="step-counter">
                <svg fill="#4bb543" width="64px" height="64px" viewBox="0 0 200.00 200.00" data-name="Layer 1"
                    id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.002">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            ...
            <div class="step-name">
                ...
                <p>
                    <span>{{ $order->arrive_client_date }}</span>
                </p>
            </div>
        </div>
        <div class="stepper-item {{ $order->delivery_date ? 'completed' : '' }}">
                ...
                <div class="card card-body">
                    <div class="driverDetails">
                        <div class="detailItem">
                            ...
                            <div class="shopImage">
                                <img src="{{ $order->shop_profile ? $order->shop_profile : 'https://cdn-icons-png.flaticon.com/512/149/149071.png' }}"
                        ...
                        <div class="detailItem">
                            <div class="shopName">
                                ...
                                <p>{{ $order->branch_phone }}</p>
                            </div>
                        </div>
                        <div class="detailItem">
                            <div class="shopName">
                                <span>Branch Area</span>
                                <p>{{ $order->branch_area }}</p>
                            </div>
                        </div>
                        <div class="detailItem">
                            <div class="shopName">
                        ...
                        <div class="detailItem">
                            <div class="shopName">
                                <span>Prep Time</span>
                                <p>{{ $order->preparation_time }} min</p>
                            </div>
                        </div>
                        <div class="detailItem">
                            <div class="shopName">
                ...
                <div class="card card-body">
                    <div class="driverDetails">
                        ...
                        <div class="detailItem">
                            <div class="shopName">
                                <span>Order Value</span>
                                <p>{{ $order->value ? $order->value . 'SAR' : '-' }}</p>
                            </div>
                        </div>
                        <div class="detailItem">
                            <div class="shopName">
                                <span>Delivary Fee</span>
                                <p>{{ $order->service_fees ? $order->service_fees . 'SAR' : '-' }}</p>
                            </div>
                        </div>
                    </div>
