        ...
        <div class="">
            ...
            <div class="flex flex-col items-center justify-center mb-192 border-b md:flex-row md:justify-between">
                <div class="flex flex-col mb-192">
                    <h3 class="text-black fs-192 fw-bold m-0 ">Cities Sales Report</h3>
                </div>
            ...
            <div class="pxy-256 bg-white br-96 mb-192 ">
                <div class="table-responsive w-full overflow-x-auto  br-64 ">
                    ...
                    <h1>Total Cities: <label id="total_cities_sum_display">0</label></h1>
                    <h1>Total Drivers: <label id="total_drivers_sum_display">0</label></h1>
                    <h1>Total UTR: <label id="total_UTR_sum_display">0</label></h1>
                    ...
                    <table id="order-list" class="table datatables table-boreder table-hover table-responsive">
                        <thead class="">
                            <tr>
                                ...
                                <th class="px-4 py-3 font-medium">Total Clients</th>
                                <th class="px-4 py-3 font-medium">Total Driver</th>
                                <th class="px-4 py-3 font-medium">Total Orders</th>
                                <th class="px-4 py-3 font-medium">Total UTR</th>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-0">
                        ...
                        <h1>Total Clients: <label id="total_branches_sum_perCity_display">0</label></h1>
                        <!-- Table of data -->
        ...
        $(document).ready(function() {
            ...
            function operatorsTable() {
                ...
                $('#order-list').DataTable({
                    ...
                    ajax: {
                        url: '{{ route('report.getCitiesSalesReportData') }}',
                        data: function(d) {
                    ...
                    drawCallback: function(settings) {
                        ...
                        if (json && json.total_amount_sum !== undefined) {
                            ...
                            $('#average_total_amount_sum_display').html((json.total_amount_sum / json
                                .total_orders_sum).toFixed(2));
                            $('#total_cities_sum_display').html(json.total_cities_sum.toFixed(2));
                            $('#total_drivers_sum_display').html(json.total_drivers_sum.toFixed(2));
                            $('#total_UTR_sum_display').html(json.total_UTR_sum.toFixed(2));

                        }

                        $('#operatoe-data-filter-btn').prop('disabled', false).html(
                            '<span>Apply Filter</span>');
                    }
                });
            }
            ...
            $(document).on('click', '.order-driver-btn', function() {
                ...
                if ($('#order-detail-table').length) {
                    ...
                    $('#order-detail-table').DataTable({
                        ...
                        ajax: {
                            url: '{{ route('report.getCitiesSalesReportDataPerclient') }}',
                            type: 'GET',
                            data: {
                                city_id: city_id,
                                fromtime: fromTime,
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    return `
                                        <a href="#"
                                        class="flex items-center justify-center w-8 h-8 text-white border rounded-lg open-drawer border-gray10 moreDetailsBtn client-sale-detail-btn"
                                        data-client_id="${data.user_id}"
                                        data-city_id="${data.city_id}">
                                            <img src="${window.location.origin}/new/src/assets/icons/view.svg" alt="View" />
                                        </a>`;
                                },
                                orderable: false,
                                searchable: false
