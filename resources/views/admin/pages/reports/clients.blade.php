    ...
    <div class="flex flex-col p-6">
        ...
        <div class="p-4 bg-white border rounded-lg border-gray1">
            ...
            <div class="w-full overflow-x-auto">
                <table id="order-list" class="w-full text-sm  text-gray-700 lg:table-fixed">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 font-medium">Branches count</th>
                            <th class="px-4 py-3 font-medium">Orders count</th>
                            <th class="px-4 py-3 font-medium">Average delivery time</th>
                            <th class="px-4 py-3 font-medium">Average waiting time</th>
