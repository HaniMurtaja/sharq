        ...
        <div class="">
            ...
            <div class="flex flex-col items-center justify-center mb-192 pb-192 border-b md:flex-row md:justify-between">
                <div class="flex flex-col">
                    <h3 class="text-black fs-192 fw-bold m-0 ">Clients Group</h3>
                </div>

                <a href="{{ route('ClientsGroupNew.create') }}"
                    class="bg-red-a3 px-4 py-2 text-white br-96 fw-bold  fs-112">+
                    New
                    Clients Group</a>
                    ...
                    <table id="order-list" class="text-center fw-semibold w-100">
                        <thead class="">
                            <tr>
                                ...
                                <th class="fs-112 gray-b4 pxy-1288 font-semibold">Calculation Method</th>
                                <th class="fs-112 gray-b4 pxy-1288 font-semibold">Default Delivery Fee</th>
                                <th class="fs-112 gray-b4 pxy-1288 font-semibold">Collection Amount</th>
                                <th class="fs-112 gray-b4 pxy-1288 font-semibold">Service Type</th>
                        ...
                        <tbody style="text-align: center; width:100%">
                            @forelse ($items as $item)
                                <tr class="fs-112 text-center black-58">
                                    ...
                                    <td class="pxy-1288">{{ @$item->calculation_method }}</td>
                                    <td class="pxy-1288">{{ @$item->default_delivery_fee }}</td>
                                    <td class="pxy-1288">{{ @$item->collection_amount }}</td>
                                    <td class="pxy-1288">{{ @$item->service_type }}</td>
                                    {{-- <td class="pxy-1288">{{ @$item->client_orders_count }}</td>
                                    <td class="pxy-1288">{{ @$item->client?->city?->name }}</td> --}}
                                    <td class="pxy-1288 d-flex gap-2">

                                        <a href="{{ route('ClientsGroupNew.edit', ['id' => $item->id]) }}"
                                        ...
                                        {{-- <form method="POST"
                                            action="{{ route('ClientsGroupNew.destroy', ['id' => $item->id]) }}"
