<section class="globalForm zonesCreateForm zones">

    <div class="globalHeader">
        <h1 id="title-zone">Create new zone</h1>
    </div>
    <form id="zone-form" class="customForm sectionGlobalForm">
        @csrf
        <input hidden name="zone_id" id="zone_id">
        <fieldset class="floating-label-input">
            <input type="text" id="zone_name" name="zone_name" required />
            <legend>Zone Name<span class="text-danger d-none">*</span></legend>
        </fieldset>
        ...
        <div id="dynamic-fields">
            ...
            <div class=" dynamic-row">
                ...
                <div class="custom-fieldset">
                    ...
                    <select class="operator area-select" name="area[]" disabled>
        ...
        <div class="templatesActionBtns w-100 d-flex justify-content-between align-items-center" dir="ltr">
            <div >
                <button style="display: none" type="button" id="delete-zone-btn" class="templateDeleteBtn">
                    Delete
                </button>
            </div>
            <div>
               
                <button type="button" id="save-zone-btn" class="templateSaveBtn">
                    Save
                </button>
            </div>
        </div>
