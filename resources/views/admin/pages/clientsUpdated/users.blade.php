                            ...
                            <form class="gap-4" id="client-user-form">
                                ...
                                <div class="templatesActionBtns mt-5 w-100 d-flex justify-content-end align-items-center"
                                    ...
                                    <div>
                                        ...
                                        <button type="button" id="save-client-user-btn"
                                            class="templateSaveBtn bg-red-a3">
                                            Save changes
                                        </button>
                                    </div>
                                </div>
                            ...
                            <form class="gap-4" id="client-exist-user-form">
                                ...
                                <div class="templatesActionBtns mt-5 w-100 d-flex justify-content-end align-items-center"
                                    ...
                                    <div>
                                        ...
                                        <button id="save-client-exist-user-btn" type="button"
                                            class="templateSaveBtn bg-red-a3">
                                            Save changes
                                        </button>
                                    </div>
            ...
            <div class="modal-body">
                ...
                <form class="gap-4 edituserModal" id="edit-user-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="position-relative">
                        <input type="file" accept="image/*" name="profile_photo" id="fileInput"
                            style="display: none;">
                        <button type="button" id="uploadButton" class="uploadImageBtn">
                            ...
                            <svg width="25.6px" height="25.6px" viewBox="0 0 32 32" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#a30133" stroke-width="1.5" stroke-linecap="round"
...
<script>
    ...
    $('#addNewUserModal').on('hidden.bs.modal', function () {
        $('#uniqueTabGroup .tab-buttons .btn').removeClass('active');
        $('#uniqueTabGroup .tab-buttons .btn[data-tab="newUser"]').addClass('active');
        $('#uniqueTabGroup .tab-pane').hide();
        $('#uniqueTabGroup .tab-pane[data-type="newUser"]').show();
    });
        ...
        function initializeSelectModalRemoteData(selector, dropdownParent, placeholder) {
            $(selector).select2({
                dropdownParent: $(dropdownParent),
                placeholder: placeholder,
                allowClear: false,
                ...
                ajax: {
                    url: ' {{route('clientupdated.getUsersSearch')}}',
                    dataType: 'json',
                    delay: 250,
                    ...
                    processResults: function(data) {
                        return {
                            results: data.map(user => ({
                                id: user.id,
                                text: user.full_name || (user.first_name + ' ' + user
                                    .last_name)
                            }))
                        };
                    },
        ...
        $(document).on('click', '#create-client-user', function() {
            ...
            $('#addNewUserModal').on('shown.bs.modal', function() {
                ...
                initializeSelectModalRemoteData(".userTemplateExisting",
          ...
          $(document).on('click', '.edit-client-user', function(event) {
            ...
            $.ajax({
                url: '{{ route('clientupdated.editClientExistUser') }}',
                method: 'GET',
                data: {
                    id: id,
                ...
                initializeSelectModal(".userTemplate",
                    ...
                    if (user) {
                        ...
                        $('select[name="role"]').val(response.role).trigger(
                            'change');
                        ...
                        if (data.user) {
                            $('#edit-user-form input[name="mac_address"]').val(response
                                .mac_address);
                        }

                        $('#edit-user-form input[name="password"]').val(
                            '');
                        var profilePhotoUrl = data.image;
