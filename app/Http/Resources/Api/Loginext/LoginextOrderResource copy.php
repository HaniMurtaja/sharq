...
class LoginextOrderResourceOld extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "city" => (isset($this->cityData->name)) ?$this->cityData->name :"",
            "shop" => (isset($this->shop)) ?$this->shop->full_name :"",
            "branch" => @$this->branch ?$this->branch->name: "",
            "branch_id" => @$this->ingr_branch_id,
            "branch_area" => (isset($this->cityData->name)) ?$this->cityData->name :"",
            ...
            "expected_delivery" => Carbon::parse($this->created_at)->addMinutes((int)($eta['default_arrive_to_pickup_time']+$eta['default_arrive_to_dropoff_time']))->format('Y-m-d H:i:s'),
            "at_pickup_at" => (isset($this->arrived_to_pickup_time)) ?Carbon::parse($this->arrived_to_pickup_time)->format('Y-m-d H:i:s'):null,
            ...
            "fees" => @$this->service_fees ? "$this->service_fees" : '0.00',
            'distance' => 4.4,
           "status" => LoginextOrderStatus::getLabelByStatus($this->status),
            "status_id" => @$this->status,
            "value" => @$this->value ?? null,
//            "payment_type" => @$this->payment_type->name ?? 'Paid',
          "payment_type" =>  'Paid',
