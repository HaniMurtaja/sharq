<?php
    ...
    use App\Repositories\GolyvRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class GolyvController extends Controller
    {
        public function __construct(OrderService $OrderService, GolyvRepository $OrderRepository)
        {
