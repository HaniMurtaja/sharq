<?php
    ...
    use App\Repositories\TrustAngelRepository;
    use App\Repositories\ZydaRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class TrustAngelController extends Controller
    {
        public function __construct( TrustAngelRepository $OrderRepository)
        {
