<?php
    ...
    use App\Repositories\QudEliteRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class QudEliteController extends Controller
    {
        public function __construct(OrderService $OrderService, QudEliteRepository $OrderRepository)
        {
