<?php
    ...
    use App\Repositories\Moon10Repository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class Moon10Controller extends Controller
    {
        public function __construct(OrderService $OrderService, Moon10Repository $OrderRepository)
        {
