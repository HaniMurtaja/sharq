<?php
    ...
    use App\Repositories\TrybotrRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class TrybotrController extends Controller
    {
        public function __construct(OrderService $OrderService, TrybotrRepository $OrderRepository)
        {
