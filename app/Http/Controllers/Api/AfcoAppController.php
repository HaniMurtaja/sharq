<?php
    ...
    use App\Repositories\AfcoAppRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class AfcoAppController extends Controller
    {
        public function __construct(OrderService $OrderService, AfcoAppRepository $OrderRepository)
        {
