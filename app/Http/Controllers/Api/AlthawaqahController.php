<?php
    ...
    use App\Repositories\AlthawaqahRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class AlthawaqahController extends Controller
    {
        public function __construct(OrderService $OrderService, AlthawaqahRepository $OrderRepository)
        {
