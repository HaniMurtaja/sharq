<?php
    ...
    use App\Repositories\DgteraRepository;
    use Illuminate\Http\Request;
    use Validator;
    use Auth;
    use App\Http\Services\OrderService;

    class DgteraController extends Controller
    {
        public function __construct(OrderService $OrderService, DgteraRepository $OrderRepository)
        {
