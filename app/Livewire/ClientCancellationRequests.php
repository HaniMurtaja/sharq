...
class ClientCancellationRequests extends Component
{
    use WithPagination;
    ...
    protected $firebaseRepository; // Corrected property name
    ...
    public function render()
    {
        ...
        })->where('status', OrderStatus::PENDING_CLIENT_ORDER_CANCELLATION);
        ...
        return view('livewire.client-cancellation-requests', [
