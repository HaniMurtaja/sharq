...
class AcceptedOrder extends Component
{
    ...
    public function render()
    {
        ...
        $this->orders_count = $ordersQuery->where('status', OrderStatus::DRIVER_ACCEPTED)->count();

        $orders = $ordersQuery->where('status', OrderStatus::DRIVER_ACCEPTED)->orderBy('created_at', 'desc')
        ...
        return view('livewire.accepted-order', [
